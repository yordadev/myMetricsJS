/**
 * This is the Common File for the Metrics System.
 * This will contain all of the Common Setting and Methods in the ENV for both of the Lib and the Metrics.
 */
const os = require('os');
...
COMMON.randomInt = function getRandomInt(max) {
 ...
 */
COMMON.RoundWholeNumber = function RoundWholeNumber(num) {
  num = num / 100;
  num = Math.round(num);
  num = num * 100;
  return num;
...
Object.keys(colors).forEach(key => {
  console['log' + key] = (strg) => {
    ...
    return process.stdout.write(colors[key] + strg + '\x1b[0m');
  }
});
...
COMMON.displayDebug = function displayDebug(postData){
